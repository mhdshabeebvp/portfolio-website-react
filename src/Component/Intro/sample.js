...
const Intro = () => {
  ...
  // // Right side heading animation
  // const headings = ["Hardware", "Embedded", "Good", "Nice"];
  ...
  return (
    <div className="intro" id="Intro">
      ...
      {/* <div className="TextHidden" style={{ animation: "fade-in 2s ease-in-out forwards" }}>
      <h1>{headings[index]}</h1>
    </div> */}

    <div className="skills-charts">
        <div id="myCanvasContainer">
          <canvas width="500" height="500" id="myCanvas" ref={this.canvasRef}>
            <ul id="tags">
